@Graph
Feature: Graph Link Verification
  ...
  Scenario Outline: User is successfully navigated to Graph Page and checks all the links on the page
    Given User is in home page after login successfully
    When User clicks on GetStarted button below "graph"
    Then User is in the "Graph" page
