...
Feature: Data Structures Link Verification
...
Scenario Outline: User is successfully navigated to DataStructures Page and checks all the links on the page

Given User is in home page after login successfully
When User clicks on GetStarted button below "data-structures-introduction" 
Then User is in the "Data Structures-Introduction" page
